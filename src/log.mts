...
function write(level: LogLevel, area: string, message: string, fields?: Record<string, unknown>): void {
    try {
...
export function logDebug(area: string, message: string, fields?: Record<string, unknown>): void {
    if (isDebugEnabled)
        write('debug', area, message, fields);
}

export function logInfo(area: string, message: string, fields?: Record<string, unknown>): void {
    write('info', area, message, fields);
}

export function logWarn(area: string, message: string, fields?: Record<string, unknown>): void {
