...
export function resolveBsPl(isRevenue: unknown, primaryGroup: unknown): boolean | null {
...
export type LedgerNature = 'nominal' | 'real' | null;
 ...
 */
export function ledgerNatureOf(closingRow: any): LedgerNature {
  if (!closingRow)
    return null;
